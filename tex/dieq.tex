...
\section{Однородные дифф. ур-я}
Однородным называют ур-е вида $y' = F(\frac{y}{x})$. \\
Не путать с НЛДУ1П -- ур-ем вида $y' + p(x)y = q(x)$

\subsection{Метод замены $y = x \cdot u$}
\textbf{Пример:}
\par $xy' - y - xe^{\frac{y}{x}} = 0$
\begin{enumerate}
    \item Убедиться, что это ур-е вида $y' = F(\frac{y}{x})$.
    ...
    \item Заменить $y = x \cdot u$, где $u = u(x)$.
        ...
        \par $u + xu' = e^u + u$
        \par $xu' = e^u$
    \item Решить полученное ур-е относительно $u = u(x)$ (методом разделения переменных).
...
\section{Ур-е вида  $y' = F(\frac{a_1x + b_1y + c_1}{a_2x + b_2y + c_2})$}
Данный тип ур-я делится на 2 подтипа:
\begin{enumerate}
...
\begin{enumerate}
    \item Убедиться, что это ур-е подтипа 12а.
...
\begin{enumerate}
    \item Убедиться, что это ур-е подтипа 12б.
    ...
    \item Заменить $\begin{cases}
        ...
        \par$\begin{cases}
                ...
                y = v + 1
            \end{cases}$
    \item Подставить это в ур-е $(*)$ из пункта 1.
        ...
        \par $v' = \frac{u - v}{-u - 2v}$
    \item Решить это ДУ, разделив числитель и знаменатель на $u$ и рассмотрев как ур-е вида $v' = F(\frac{v}{u})$).
